...
const { ChainId } = require("@amblade/patswap-sdk");
...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the amblade/patswap-icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("amblade/patswap-icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/amblade/patswap-icons/master/token/${icon}.jpg`;
